...
{
    internal class RTThreadPageTaskPerformanceMemoryFreeViewModel : BindableBase, INavigationAware, IRegionMemberLifetime
    {
        ...
        public RTThreadPageTaskPerformanceMemoryFreeViewModel()
        {
        }
