...
{
    public class RTThreadPageSettingViewModel : BindableBase, INavigationAware, IRegionMemberLifetime
    {
        ...
        public RTThreadPageSettingViewModel(ISerial serial, IIniFile iniFile, IEventAggregator eventAggregator)
        {
            _serial = serial;
            _iniFile = iniFile;
